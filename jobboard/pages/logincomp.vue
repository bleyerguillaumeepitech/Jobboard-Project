    ...
    <div class="d-flex justify-content-center mt-5">
      <div class=" col-md-7 col-lg-7 col-xl-6" id="identification">
          <form class="col-10 offset-1 mt-5">
                ...
                <p class="" style="color: white">Postez vos offres d’emploi, et recrutez de nouveau talent !</p>
                <div class="mt-5">
                    <h6 class="" style="color: white">E-mail Entreprise *</h6>
                    <input type="text" class="form-control" aria-describedby="basic-addon1" v-model="email">
                </div>
                <div class="mt-5">
                    <h6 class="" style="color: white">Mot de passe *</h6>
                    <input type="password" class="form-control" aria-describedby="basic-addon1" v-model="password">
                </div>
                <div class="mt-1">
                  <h6 class="" style="color: white"><a href="/mdpforgot" id="mdp">Mot de passe oublié ?</a></h6>
                </div>
                ...
                <div class="d-flex justify-content-center">
                  ...
                  <a href="/register_companies" class="mx-1" id="mdp">S'inscrire</a>
                </div>
          </form>
      </div>
    </div>
...
export default {
  ...
  methods: {
   async login(){
     try {
       const response = await this.$axios.post("http://127.0.0.1:3003/api/login-comp", {
      ...
      const id = localStorage.getItem('id')
       this.$router.push(`/dashboard_companies/${id}`)
     } catch (error) {
       console.log(error)
     }
    }
